...
public class DecoratorTest {
    ...
    public void TestGunDecorator(){
        Gun gun = GunFactory.createGun(WEAPON_TYPE.SIMPLE_GUN);
        Assert.assertEquals("Gun", gun.getDescription());
        Gun gun1 = GunFactory.createGun(WEAPON_TYPE.BAYONET);
        ...
        Gun gun2 = GunFactory.createGun(WEAPON_TYPE.PIMPED_GUN);
        ...
        Gun gun3 = GunFactory.createGun(WEAPON_TYPE.SNIPER);
