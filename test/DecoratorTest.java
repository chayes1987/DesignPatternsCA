...
public class DecoratorTest {
    ...
    public void TestGunDecorator(){
        ...
        Gun gun1 = GunFactory.createWeapon(WEAPON_TYPE.BAYONET);
        ...
        Gun gun2 = GunFactory.createWeapon(WEAPON_TYPE.PIMPED_GUN);
        ...
        Gun gun3 = GunFactory.createWeapon(WEAPON_TYPE.SNIPER);
